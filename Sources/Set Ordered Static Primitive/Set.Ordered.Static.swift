...
extension Set.Ordered where Element: ~Copyable {
    ...
    ///
    /// Composes `Buffer<Storage<Element>.Contiguous<Memory.Heap<Element>>>.Linear.Inline<capacity>` for element storage and
    ...
    public struct Static<let capacity: Int>: ~Copyable {
        ...
        @usableFromInline
        internal var buffer: Buffer<Storage<Element>.Contiguous<Memory.Heap<Element>>>.Linear.Inline<capacity>
        ...
        @inlinable
        public init() {
            self.buffer = Buffer<Storage<Element>.Contiguous<Memory.Heap<Element>>>.Linear.Inline<capacity>()
