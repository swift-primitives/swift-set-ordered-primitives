...
//
// Re-uses Buffer.Linear.Small.Scalar (single-pass, consuming), mirroring buffer-linear.
// The consuming `makeIterator()` witness is a public member in the type module
// (Set.Ordered.Small+Sequenceable.swift) per [MOD-036] refined-C; this conformance is thin.
//
// `Set.Ordered.Small` does not conform to `Swift.Sequence`: the span-primitive iteration
